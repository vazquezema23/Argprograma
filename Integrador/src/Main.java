...
public class Main {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\Users\vazqu\Documents\DESARROLLADOR JAVA\Argentina Programa\Integrador" + DB_NAME;
    ...
    public static void main(String[] args) {
        try {
            ...
            /*
            insertPronostico(statement, "Argentina", "x", "", "", "Arabia Saudita", 1, 1);
            insertPronostico(statement, "Polonia", "", "x", "", "Mexico", 2, 1);
            insertPronostico(statement, "Argentina", "x", "", "", "Mexico", 3, 2);
            insertPronostico(statement, "Arabia Saudita", "", "", "x", "Polonia", 4, 2);
            insertPronostico(statement, "Argentina", "x", "", "", "Arabia Saudita", 1, 1);
            insertPronostico(statement, "Polonia", "", "", "x", "Mexico", 2, 1);
            insertPronostico(statement, "Argentina", "x", "", "", "Mexico", 3, 2);
            insertPronostico(statement, "Arabia Saudita", "", "x", "", "Polonia", 4, 2);
           */
            ...
            String rutaArchivoResultados = "C:\Users\vazqu\Documents\DESARROLLADOR JAVA\Argentina Programa\Integrador\src";
    ...
    private static List<Ronda> ordenarPorRondas(List<Partido> partidos, List<Pronostico> pronosticos, List<Ronda> listaDeRonda, int cantRondas) {
        ...
        for (int i = 1; i <= cantRondas; i++) {
            ...
            Participante mariana = new Participante;
